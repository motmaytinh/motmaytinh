...
My skills:  
[![My Skills](https://skillicons.dev/icons?i=java,kotlin,python,ts,bash,css,html,docker,firebase,github,gitlab,linux,raspberrypi,idea,vscode,androidstudio,fastapi,spring,maven,nodejs,express,mongodb,redis,postman)](https://skillicons.dev)
